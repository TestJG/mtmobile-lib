...
import { mustNotBeBelow, mustNotBeAbove, mustBeBetween } from './coercion';
import {
...
describe('Utils', () => {
    describe('Form Utils Tests', () => {
        ...
        //             () =>
        //                 (ageField = field(100, {
        //                     coerce: [mustNotBeBelow(18), mustNotBeAbove(90)]
        //                 }))
        //         );
        ...
        //             }));
        //     });
        //     describe('when a field with validators function is created', () => {
        //         let ageField: FormItem<number>;
        //         beforeAll(
        //             () =>
        //                 (ageField = field(10, {
        //                     validators: shouldBeGreaterThanOrEqualTo(18)
        //                 }))
        //         );
        //         it('it should have init value 10', () =>
        //             expect(ageField.initValue).toEqual(10));
        //         it('it should have a coerced value 10', () =>
        //             expect(ageField.value).toEqual(10));
        ...
        //             expect(ageField.isValid).not.toBeTruthy());
        //         it('it should not show errors', () =>
        //             expect(ageField.showError).not.toBeTruthy());
        //         it('it should have expected errors', () =>
        //             expect(ageField.errors).toEqual([
        //                 'Should be greater than or equal to 18'
        //             ]));
        //         [0, 1, -1, 100, -100, 1e20, 1e-20].forEach(v =>
        //             it(`value ${v} should be validated properly`, () => {
        //                 if (v >= 18) {
        //                     expect(ageField.validator(v)).toEqual([]);
        //                 } else {
        //                     expect(ageField.validator(v)).toEqual([
        ...
        //         );
        //     });
        //     describe('when a field with validators array is created', () => {
        //         let ageField: FormItem<number>;
        //         beforeAll(
        //             () =>
        //                 (ageField = field(100, {
        ...
        //                         shouldBeLessThanOrEqualTo(90)
        //                     ]
        //                 }))
        //         );
        //         it('it should have init value 100', () =>
        //             expect(ageField.initValue).toEqual(100));
        //         it('it should have a coerced value 100', () =>
        //             expect(ageField.value).toEqual(100));
        //         it("it's validator should be a function", () =>
        //             expect(ageField.validator).toBeInstanceOf(Function));
        //         it('it should not be dirty', () =>
        //             expect(ageField.isDirty).toBeFalsy());
        ...
        //             expect(aGroup.showError).not.toBeTruthy());
        //     });
        //     describe('when a group with coerced fields is created', () => {
        //         let aGroup: FormGroup<any>;
        //         beforeAll(
        //             () =>
        //                 (aGroup = group({
        ...
        //         it('it should have init value undefined', () =>
        //             expect(aGroup.initValue).toEqual(undefined));
        //         it('it should have value with given coerced fields', () =>
        //             expect(aGroup.value).toEqual({
        //                 firstName: '',
        //                 lastName: '',
        //                 age: 18
        ...
        //             expect(aGroup.showError).not.toBeTruthy());
        //     });
        //     describe('when a group with coerced value is created', () => {
        //         let aGroup: FormGroup<any>;
        //         beforeAll(
        //             () =>
        //                 (aGroup = group(
        ...
        //         it('it should not show errors', () =>
        //             expect(aGroup.showError).not.toBeTruthy());
        //         it('it\'s fields should have the same value as the group', () => {
        //             const groupValue = aGroup.value;
        //             const fieldsValue = {
        //                 firstName: aGroup.fields['firstName'].value,
        //                 lastName: aGroup.fields['lastName'].value,
        //                 age: aGroup.fields['age'].value
        //             };
        //             expect(fieldsValue).toEqual(groupValue);
        //         });
        //     });
        // });
        // // describe('list', () => {
        ...
        // //         let aList: FormList<any>;
        // //         beforeAll(
        // //             () => (aList = list([field(''), field(''), field(18)]))
        // //         );
        // //         it('it should have init value undefined', () =>
        // //             expect(aList.initValue).toEqual(undefined));
        // //         it('it should have value with given fields', () =>
        // //             expect(aList.value).toEqual(['', '', 18]));
        // //         it('it should not be dirty', () =>
        // //             expect(aList.isDirty).toBeFalsy());
        // //         it('it should not be touched', () =>
        // //             expect(aList.isTouched).toBeFalsy());
