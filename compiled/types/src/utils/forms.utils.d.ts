...
export declare const locateInGroupOrFail: <T>(item: FormGroup<T>, path: string, failIfNoChild?: boolean) => [keyof T, FormItem<keyof T>, string];
export declare const locateInListingOrFail: <T extends any[]>(item: FormListing<T>, path: string, failIfNoChild?: boolean) => [number, FormItem<T>, string];
...
export declare const createListingValue: <T extends T[]>(fields: FormItem<T[0]>[]) => T;
export declare const createListingInitValue: <T extends T[]>(fields: FormItem<T[0]>[]) => T;
export interface SetValueOptions {
    affectDirty: boolean;
    compareValues: boolean;
    initialization: boolean;
}
export declare function setValueInternal<T>(item: FormItem<T>, value: ValueOrFunc, path: string, options?: Partial<SetValueOptions>): FormItem<T>;
